...
type pokemon = {
  ...
  // "start": "tsc && node ./build/exercicio4.js"
  // e executando start no terminal
  
  // c) E se este arquivo estivesse dentro de uma pasta chamada
  //  `src`. O processo seria diferente? Se sim, descreva as diferenças.
  // sim, sem definir o caminho o ts nao ira rodar
